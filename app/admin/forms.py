...
class CreateLesson(FlaskForm):
    ...
    days = SelectField('Day',choices =[("1","Monday"),("2","Tuesday"),("3","Wednesday"),("4","Thursday"),("5","Friday")("6","Weekend Work")],validators = [Required()])
    weeks =  SelectField('Week',choices = [("1","Pre-course"),("2","Week 1"),("3","Week 2"),("4","Week 3 "),("5","Week 4"),("6","Week 5")],validators = [Required()])
